...
public class Tabela extends javax.swing.JFrame {
    ...
    public Tabela(Pessoa p1){
        initComponents();
        DefaultTableModel modelo = (DefaultTableModel) tablegrid.getModel();
        Object[] dados = {p1.getNome(), p1.getEndereco(), p1.getDataNascimento(), p1.getSexo()};
        modelo.addRow(dados);
    }
    ...
    private void initComponents() {
        ...
        tablegrid.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Endereco", "Data de Nascimento", "Sexo"
            }
        ) {
        ...
        if (tablegrid.getColumnModel().getColumnCount() > 0) {
